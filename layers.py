...
class Loss(nn.Module):
    ...
    def forward(self, output, labels, train = True):
        ...
        if len(pos_output)>0:
            ...
            regress_losses_data = [l.item() for l in regress_losses] #[l.data[0] for l in regress_losses]  ###NX waring
        ...
        classify_loss_data = classify_loss.item() #classify_loss.data[0]  #######NX warning
